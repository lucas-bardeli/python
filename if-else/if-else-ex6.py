...
sal_min = sal_liquido = sal_bruto = 0.0
irrf = gratificacao = 0.0
v_hora_trab = v_dependente = v_hora_extra = 0.0
n_dependente = n_horas_trab = n_hora_extra = 0
...
print()
print(f"O salario a receber é de: R$ {sal_liquido:,.2f}")
print()